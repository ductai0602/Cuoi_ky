	...
	public Thong_tin_DK() {
		...
		btn_Them.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				st.setSDT(Integer.valueOf(tf_SDT.getText()));
		...
		lblNewLabel_1_3.setBounds(437, 473, 137, 33);
		...
		lblNewLabel_1_1_1.setBounds(37, 602, 137, 33);
		contentPane.add(lblNewLabel_1_1_1);
		
		tf_SDT = new JTextField();
		tf_SDT.setFont(new Font("Tahoma", Font.PLAIN, 18));
		tf_SDT.setColumns(10);
		tf_SDT.setBounds(144, 602, 222, 33);
		...
		comboBox_gioiTinh.setBounds(530, 562, 137, 30);
		contentPane.add(comboBox_gioiTinh);
		
		JLabel lblNewLabel_1_6_1 = new JLabel("  YYYY/MM/DD");
		lblNewLabel_1_6_1.setForeground(Color.GRAY);
		lblNewLabel_1_6_1.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_1_6_1.setBounds(530, 473, 137, 33);
		...
		tf_ngaySinh.setBounds(530, 473, 222, 33);
